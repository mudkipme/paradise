...
export default class Pokemon extends Model {
    ...
    public getTrainer: BelongsToGetAssociationMixin<Trainer>;
    public setTrainer: BelongsToSetAssociationMixin<Trainer, string>;
    public happiness: number;
    public nickname: string | null;
    public getOriginalTrainer: BelongsToGetAssociationMixin<Trainer>;
    public setOriginalTrainer: BelongsToSetAssociationMixin<Trainer, string>;
    public displayOT: string | null;
    public meetLevel: number | null;
    public meetPlaceIndex: string | null;
    public meetDate: Date | null;
    public birthDate: Date | null;
    public getMother: BelongsToGetAssociationMixin<Pokemon>;
    public getFather: BelongsToGetAssociationMixin<Pokemon>;
